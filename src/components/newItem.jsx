...
export default function NewItem() {
  ...
  const { message, isSuccess } = useSelector((state) => state.items);
  ...
  return (
    <div>
      ...
      <Dialog open={open} onClose={handleClose}>
        <DialogTitle
          style={{ height: "30px", borderBottom: "1px solid #EFEFF0" }}
        >
          Create Item
        </DialogTitle>
          ...
          <form>
            ...
            <div style={{ textAlign: "right" }}>
              <ThemeProvider theme={theme}>
                ...
                <Button color="grey" variant="contained" onClick={handleSubmit}>
                  Create Event
                </Button>
              </ThemeProvider>
            </div>
